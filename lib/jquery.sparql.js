...
(function($){
  ...
  var Query = function(endpoint, options, parentQuery) {
    ...
    this.orders = [];
    this.limitCount = -1;
    this.groupbyFlag = undefined; //added
    this.offsetCount = 0;
    this._prevSubj = null;
    this._prevProp = null;
    this._storedQuery = "";
  ...
  Query.prototype.execute = function(callback) {
    ...
    var _preproc = function(data) {
      var results;
      if(self.localhost) results = data.results.bindings;
      else results = data.query.results.sparql.result;
      var cleaned_results = [];
  ...
  Query.prototype.serialiseQuery = function() {
    ...
    if (typeof this.groupbyFlag != 'undefined')
    {
      queryString.push("GROUP BY "+this.groupbyFlag);
    }
